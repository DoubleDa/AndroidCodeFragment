 ...
 */
public class UnableCopyEditText extends EditText {
    ...
    public UnableCopyEditText(Context context) {
        super(context);
    ...
    public UnableCopyEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
    ...
    public UnableCopyEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class ActionModeCallbackInterceptor implements ActionMode.Callback {
        private final String TAG = UnableCopyEditText.class.getSimpleName();
